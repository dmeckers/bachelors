...
abstract class UserPrivacySettingsRepositoryInterface {
  abstract final PrivacySettingsQueueInterface privacyQueue;
  ...
  Future<UserProfilePrivacySettingsModel> getCurrentUserPrivacySettings();
}
