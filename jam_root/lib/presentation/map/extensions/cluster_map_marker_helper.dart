...
class MapHelper {
  ...
  static Future<Fluster<ClusteredMapMarker>> initClusterManager(
    List<ClusteredMapMarker> markers,
    int minZoom,
    int maxZoom,
  ) async {
    return Fluster<ClusteredMapMarker>(
        minZoom: minZoom,
        maxZoom: maxZoom,
        radius: 150,
        extent: 2048,
  ...
  static Future<List<Marker>> getClusterMarkers(
    Fluster<ClusteredMapMarker>? clusterManager,
    double currentZoom,
    Color clusterColor,
