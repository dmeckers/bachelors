...
class ChatsStateNotifier extends _$ChatsStateNotifier {
  @override
  FutureOr<Chats> build() {
    ref.read(chatRealtimeServiceProvider).get$().doOnData((chats) {
      final mapped = chats
          .map(
            (e) => e.copyWith(
              chatEventType: ChatEventType.stopTyping,
